...
>
    ...
    <header class="max-w-6xl mx-auto px-6 py-6 flex justify-between items-center">
        ...
        <div class="flex items-center gap-3">
            ...
            <a
                href="mailto:muradmohhajaj@gmail.com"
                class="w-10 h-10 bg-white dark:bg-[#11151D] shadow-sm border border-slate-200 dark:border-white/10 rounded-xl flex items-center justify-center hover:scale-105 transition-transform text-slate-700 dark:text-slate-200"
                title="Email"
                aria-label="Email Murad Hajjaj"
            >
                <svg
                    class="w-5 h-5"
                    fill="none"
            ...
            <a
                href="https://www.youtube.com/@muradmhajjaj6511"
                target="_blank"
                rel="noopener noreferrer"
                class="w-10 h-10 bg-white dark:bg-[#11151D] shadow-sm border border-slate-200 dark:border-white/10 rounded-xl flex items-center justify-center hover:scale-105 transition-transform text-slate-700 dark:text-slate-200"
                title="YouTube"
                aria-label="Murad's YouTube Channel"
            >
                <svg
                    class="w-5 h-5"
                    fill="currentColor"
            ...
            <a
                href="https://github.com/hajaj-Murad-M-2001"
                target="_blank"
                rel="noopener noreferrer"
                class="w-10 h-10 bg-white dark:bg-[#11151D] shadow-sm border border-slate-200 dark:border-white/10 rounded-xl flex items-center justify-center hover:scale-105 transition-transform text-slate-700 dark:text-slate-200"
                title="GitHub"
                aria-label="Murad's GitHub Profile"
            >
                <svg
                    class="w-5 h-5"
                    fill="currentColor"
            ...
            <a
                href="https://mostaql.com/u/MuradMh/portfolio"
                target="_blank"
                rel="noopener noreferrer"
                class="w-10 h-10 bg-white dark:bg-[#11151D] shadow-sm border border-slate-200 dark:border-white/10 rounded-xl flex items-center justify-center hover:scale-105 transition-transform text-slate-700 dark:text-slate-200"
                title="Mostaql Portfolio"
                aria-label="Murad's Mostaql Portfolio"
            >
                <svg
                    class="w-5 h-5"
                    fill="none"
        ...
        <div class="hidden sm:flex items-center gap-2 bg-white dark:bg-[#11151D] px-4 py-2 rounded-full shadow-sm border border-slate-200 dark:border-white/10 text-xs font-semibold text-slate-600 dark:text-slate-300">
            <span
                    ...
                    <div class="bg-white dark:bg-[#11151D] border border-slate-200 dark:border-white/10 rounded-3xl p-6 md:p-7 shadow-sm hover:shadow-lg hover:-translate-y-0.5 transition-all duration-300">
                        ...
                        <div class="flex flex-col md:flex-row md:items-start md:justify-between gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-slate-500 dark:text-slate-400 mt-1">
                                    Responsive Web Development &amp; Back-End Foundations
                                </p>
                            </div>
                    ...
                    <div class="bg-white dark:bg-[#11151D] border border-slate-200 dark:border-white/10 rounded-3xl p-6 md:p-7 shadow-sm hover:shadow-lg hover:-translate-y-0.5 transition-all duration-300">
                        ...
                        <div class="flex flex-col md:flex-row md:items-start md:justify-between gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-slate-500 dark:text-slate-400 mt-1">
                                    RCF Foundation · Gaza Strip, Palestine
                                </p>
                            </div>
                    ...
                    <div class="bg-white dark:bg-[#11151D] border border-slate-200 dark:border-white/10 rounded-3xl p-6 md:p-7 shadow-sm hover:shadow-lg hover:-translate-y-0.5 transition-all duration-300">
                        ...
                        <div class="flex flex-col md:flex-row md:items-start md:justify-between gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-slate-500 dark:text-slate-400 mt-1">
                                    Saqalla Sweets · Gaza Strip, Palestine
                                </p>
                            </div>
    ...
    >
        ...
        >
            ...
            <div
                class="bg-slate-100 dark:bg-white/5 p-1.5 rounded-2xl flex items-center gap-1"
                role="tablist"
            >
            ...
            >
                ...
                <div>
                    <label
                        for="cf-name"
                        class="block text-xs font-bold text-slate-700 dark:text-slate-200 mb-1"
                    >
                        Name *
                    </label>
