...
>
    ...
    <main class="max-w-6xl mx-auto px-6 pt-6 pb-28 space-y-10">
        ...
        <!-- Page intro -->
        <div>
            <span class="font-casual text-[#4F5BFF] text-3xl block -mb-1 rotate-[-2deg]">My background</span>
            <h1 class="font-heading text-4xl md:text-6xl uppercase tracking-tight text-slate-900 dark:text-white">Experience &amp; Education</h1>
        ...
        <section id="experience" class="relative">
            <div class="hidden md:block absolute left-6 top-3 bottom-3 w-px bg-slate-200 dark:bg-slate-800" aria-hidden="true"></div>
                    ...
                    <div class="bg-white dark:bg-slate-900 dark:border dark:border-slate-800 border border-slate-200 rounded-3xl p-6 md:p-7 shadow-sm hover:shadow-lg hover:-translate-y-0.5 transition-all duration-300">
                        <div class="flex flex-col md:flex-row md:items-start md:justify-between gap-3">
                            <div>
                                ...
                                <h3 class="font-bold text-lg md:text-xl text-slate-900 dark:text-white mt-3">Software Engineering &amp; IT</h3>
                                <p class="text-xs text-slate-500 dark:text-slate-400 mt-1">Bachelor's Degree · Islamic University</p>
                            </div>
                            <span class="w-fit text-xs font-semibold text-[#4F5BFF] bg-[#4F5BFF]/5 border border-[#4F5BFF]/10 px-3 py-1.5 rounded-full">Graduated 2024</span>
                        </div>
                        <p class="text-sm text-slate-600 dark:text-slate-300 leading-relaxed mt-5 max-w-3xl">
                            Comprehensive coursework in Software Development, Networking, Database Management, and Electronics, establishing a strong foundation in both software architecture and system engineering.
                        </p>
                        <div class="flex flex-wrap gap-2 mt-5">
                            <span class="bg-slate-100 dark:bg-slate-800 dark:text-slate-200 text-slate-700 text-xs px-3 py-1.5 rounded-lg font-medium">Software Engineering</span>
                            <span class="bg-slate-100 dark:bg-slate-800 dark:text-slate-200 text-slate-700 text-xs px-3 py-1.5 rounded-lg font-medium">Database Management</span>
                            <span class="bg-slate-100 dark:bg-slate-800 dark:text-slate-200 text-slate-700 text-xs px-3 py-1.5 rounded-lg font-medium">Networking</span>
                        </div>
                    </div>
                </article>
                ...
                <article class="relative md:pl-16">
                    ...
                    <div class="bg-white dark:bg-slate-900 dark:border dark:border-slate-800 border border-slate-200 rounded-3xl p-6 md:p-7 shadow-sm hover:shadow-lg hover:-translate-y-0.5 transition-all duration-300">
                        <div class="flex flex-col md:flex-row md:items-start md:justify-between gap-3">
                            ...
                            <span class="w-fit text-xs font-semibold text-slate-500 dark:text-slate-400 bg-slate-100 dark:bg-slate-800 px-3 py-1.5 rounded-full">Dec 2025 – Jan 2026</span>
                        </div>
                        <p class="text-sm text-slate-600 dark:text-slate-300 leading-relaxed mt-5 max-w-3xl">
                            Developed responsive web projects with HTML, CSS, and JavaScript. Introduced to back-end concepts and built practical web projects using Git-based workflows.
                        </p>
                        <div class="flex flex-wrap gap-2 mt-5">
                            <span class="bg-slate-100 dark:bg-slate-800 dark:text-slate-200 text-slate-700 text-xs px-3 py-1.5 rounded-lg font-medium">HTML/CSS</span>
                            <span class="bg-slate-100 dark:bg-slate-800 dark:text-slate-200 text-slate-700 text-xs px-3 py-1.5 rounded-lg font-medium">JavaScript</span>
                            <span class="bg-slate-100 dark:bg-slate-800 dark:text-slate-200 text-slate-700 text-xs px-3 py-1.5 rounded-lg font-medium">Responsive Design</span>
                            <span class="bg-slate-100 dark:bg-slate-800 dark:text-slate-200 text-slate-700 text-xs px-3 py-1.5 rounded-lg font-medium">Git &amp; GitHub</span>
                        </div>
                    </div>
                </article>
                ...
                <article class="relative md:pl-16">
                    ...
                    <div class="bg-white dark:bg-slate-900 dark:border dark:border-slate-800 border border-slate-200 rounded-3xl p-6 md:p-7 shadow-sm hover:shadow-lg hover:-translate-y-0.5 transition-all duration-300">
                        <div class="flex flex-col md:flex-row md:items-start md:justify-between gap-3">
                            ...
                            <span class="w-fit text-xs font-semibold text-slate-500 dark:text-slate-400 bg-slate-100 dark:bg-slate-800 px-3 py-1.5 rounded-full">May 2025 – Jul 2025</span>
                        </div>
                        <p class="text-sm text-slate-600 dark:text-slate-300 leading-relaxed mt-5 max-w-3xl">
                            Trained on diagnosing and resolving system and network issues, and on installing and configuring software and operating systems.
                        </p>
                        <div class="flex flex-wrap gap-2 mt-5">
                            <span class="bg-slate-100 dark:bg-slate-800 dark:text-slate-200 text-slate-700 text-xs px-3 py-1.5 rounded-lg font-medium">Networking</span>
                            <span class="bg-slate-100 dark:bg-slate-800 dark:text-slate-200 text-slate-700 text-xs px-3 py-1.5 rounded-lg font-medium">Troubleshooting</span>
                            <span class="bg-slate-100 dark:bg-slate-800 dark:text-slate-200 text-slate-700 text-xs px-3 py-1.5 rounded-lg font-medium">OS Configuration</span>
                        </div>
                    </div>
                </article>
                ...
                <article class="relative md:pl-16">
                    ...
                    <div class="bg-white dark:bg-slate-900 dark:border dark:border-slate-800 border border-slate-200 rounded-3xl p-6 md:p-7 shadow-sm hover:shadow-lg hover:-translate-y-0.5 transition-all duration-300">
                        <div class="flex flex-col md:flex-row md:items-start md:justify-between gap-3">
                            ...
                            <span class="w-fit text-xs font-semibold text-slate-500 dark:text-slate-400 bg-slate-100 dark:bg-slate-800 px-3 py-1.5 rounded-full">Jan 2025 – Apr 2025</span>
                        </div>
                        <p class="text-sm text-slate-600 dark:text-slate-300 leading-relaxed mt-5 max-w-3xl">
                            Developed small applications using HTML, CSS, and JavaScript, trained on diagnosing system and network issues, and practiced version control with Git and GitHub.
                        </p>
                        <div class="flex flex-wrap gap-2 mt-5">
                            <span class="bg-slate-100 dark:bg-slate-800 dark:text-slate-200 text-slate-700 text-xs px-3 py-1.5 rounded-lg font-medium">HTML/CSS</span>
                            <span class="bg-slate-100 dark:bg-slate-800 dark:text-slate-200 text-slate-700 text-xs px-3 py-1.5 rounded-lg font-medium">JavaScript</span>
                ...
                <article class="relative md:pl-16">
                    ...
                    <div class="bg-white dark:bg-slate-900 dark:border dark:border-slate-800 border border-slate-200 rounded-3xl p-6 md:p-7 shadow-sm hover:shadow-lg hover:-translate-y-0.5 transition-all duration-300">
                        <div class="flex flex-col md:flex-row md:items-start md:justify-between gap-3">
                            ...
                            <span class="w-fit text-xs font-semibold text-slate-500 dark:text-slate-400 bg-slate-100 dark:bg-slate-800 px-3 py-1.5 rounded-full">Jan 2025 – Dec 2025</span>
                        </div>
                        <p class="text-sm text-slate-600 dark:text-slate-300 leading-relaxed mt-5 max-w-3xl">
                            Coordinated field logistics and movement plans for data collection teams. Audited and verified field data using KoboToolbox, ensuring high data integrity, and prepared comprehensive movement reports.
                        </p>
                        <div class="flex flex-wrap gap-2 mt-5">
                            <span class="bg-slate-100 dark:bg-slate-800 dark:text-slate-200 text-slate-700 text-xs px-3 py-1.5 rounded-lg font-medium">KoboToolbox</span>
                            <span class="bg-slate-100 dark:bg-slate-800 dark:text-slate-200 text-slate-700 text-xs px-3 py-1.5 rounded-lg font-medium">Data Validation</span>
                            <span class="bg-slate-100 dark:bg-slate-800 dark:text-slate-200 text-slate-700 text-xs px-3 py-1.5 rounded-lg font-medium">Field Monitoring</span>
                            <span class="bg-slate-100 dark:bg-slate-800 dark:text-slate-200 text-slate-700 text-xs px-3 py-1.5 rounded-lg font-medium">Reporting</span>
                        </div>
                    </div>
                </article>
                ...
                <article class="relative md:pl-16">
                    ...
                    <div class="bg-white dark:bg-slate-900 dark:border dark:border-slate-800 border border-slate-200 rounded-3xl p-6 md:p-7 shadow-sm hover:shadow-lg hover:-translate-y-0.5 transition-all duration-300">
                        <div class="flex flex-col md:flex-row md:items-start md:justify-between gap-3">
                            ...
                            <span class="w-fit text-xs font-semibold text-slate-500 dark:text-slate-400 bg-slate-100 dark:bg-slate-800 px-3 py-1.5 rounded-full">Feb 2022 – Oct 2023</span>
                        </div>
                        <p class="text-sm text-slate-600 dark:text-slate-300 leading-relaxed mt-5 max-w-3xl">
                            Managed financial records and accounts using the Al-Aseel Accounting System with a zero-error rate. Facilitated procurement, reviewed supplier invoices, and reconciled inventory for full resource accountability.
                        </p>
                        <div class="flex flex-wrap gap-2 mt-5">
                            <span class="bg-slate-100 dark:bg-slate-800 dark:text-slate-200 text-slate-700 text-xs px-3 py-1.5 rounded-lg font-medium">Al-Aseel Accounting</span>
                            <span class="bg-slate-100 dark:bg-slate-800 dark:text-slate-200 text-slate-700 text-xs px-3 py-1.5 rounded-lg font-medium">Financial Records</span>
                            <span class="bg-slate-100 dark:bg-slate-800 dark:text-slate-200 text-slate-700 text-xs px-3 py-1.5 rounded-lg font-medium">Inventory</span>
                            <span class="bg-slate-100 dark:bg-slate-800 dark:text-slate-200 text-slate-700 text-xs px-3 py-1.5 rounded-lg font-medium">Procurement</span>
                        </div>
                    </div>
                </article>
