...
>
    ...
    <main class="max-w-6xl mx-auto px-6 space-y-10" x-data="{ activeFilter: 'All' }">
        ...
        <a href="{{ url('/') }}" class="inline-flex items-center gap-2 text-sm font-semibold text-slate-500 hover:text-[#4F5BFF] transition-colors">
            &larr; Back to Home
        </a>

        <!-- Page Title & Description -->
        <div class="space-y-3">
            <h1 class="font-heading text-4xl md:text-5xl uppercase tracking-tight text-slate-900">Projects I&rsquo;ve Built</h1>
        ...
        <div class="flex flex-wrap items-center gap-2 pt-2" role="group" aria-label="Filter projects by technology">
            <template x-for="filter in ['All', 'Backend', 'Full-Stack', 'Laravel', 'Node.js']">
                <button @click="activeFilter = filter"
                        :class="activeFilter === filter ? 'bg-[#4F5BFF] text-white shadow-md shadow-[#4F5BFF]/20' : 'bg-white text-slate-600 border border-slate-200 hover:bg-slate-50'"
        ...
        <div
            ...
            x-transition
            class="bg-gradient-to-br from-white to-[#F8F9FF] border-2 border-[#4F5BFF]/30 rounded-3xl p-8 md:p-10 shadow-lg relative overflow-hidden flex flex-col justify-between hover:shadow-xl transition-shadow duration-300"
        >
            ...
            <div class="space-y-4">
                ...
                <h2 class="font-heading text-2xl md:text-3xl text-slate-900">Clean Blog CMS</h2>
                ...
                <div class="flex flex-wrap gap-2 pt-2">
                    <span class="bg-slate-100 text-slate-700 text-xs px-3 py-1 rounded-lg font-medium">Laravel</span>
                    <span class="bg-slate-100 text-slate-700 text-xs px-3 py-1 rounded-lg font-medium">MySQL</span>
                    <span class="bg-slate-100 text-slate-700 text-xs px-3 py-1 rounded-lg font-medium">REST API</span>
                    <span class="bg-slate-100 text-slate-700 text-xs px-3 py-1 rounded-lg font-medium">Authentication</span>
                </div>
            </div>

            <div class="pt-8 mt-8 border-t border-slate-200/60 flex flex-wrap items-center justify-between gap-4">
                <div class="flex items-center gap-4">
                    ...
                    <a href="https://github.com/hajaj-Murad-M-2001/clean-blog-----" target="_blank" class="text-slate-700 hover:text-[#4F5BFF] text-sm font-bold inline-flex items-center gap-1">
                        Live Demo ↗
                    </a>
                </div>
                <a href="https://github.com/hajaj-Murad-M-2001/clean-blog-----" target="_blank" class="text-slate-700 hover:text-[#4F5BFF] text-sm font-bold inline-flex items-center gap-1">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div
                ...
                x-transition
                class="bg-white border border-slate-200/80 rounded-3xl p-8 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex flex-col justify-between"
            >
                <div class="space-y-4">
                    <div class="flex items-center justify-between">
                        <span class="bg-[#4F5BFF]/10 text-[#4F5BFF] text-xs font-bold px-3 py-1 rounded-full">Full-Stack · UI/UX</span>
                        <span class="w-9 h-9 rounded-xl bg-slate-50 border border-slate-100 flex items-center justify-center text-[#4F5BFF]">
                    ...
                    <h3 class="font-heading text-xl text-slate-900 leading-snug">E-Restaurant Platform</h3>
                    <p class="text-slate-600 text-sm leading-relaxed">Integrated food ordering web platform with superior user experience (UI/UX) and full management dashboard for orders and meals.</p>
                    <div class="flex flex-wrap gap-1.5 pt-2">
                        <span class="bg-slate-100 text-slate-700 text-[11px] px-2.5 py-1 rounded-md font-medium">Laravel</span>
                        <span class="bg-slate-100 text-slate-700 text-[11px] px-2.5 py-1 rounded-md font-medium">UI/UX</span>
                        <span class="bg-slate-100 text-slate-700 text-[11px] px-2.5 py-1 rounded-md font-medium">MySQL</span>
                    </div>
                </div>
                <div class="pt-6 mt-6 border-t border-slate-100 flex items-center justify-between">
                    ...
                    <a href="https://mostaql.com/portfolio/3364761-%D8%AA%D8%B7%D9%88%D9%8A%D8%B1-%D9%85%D9%86%D8%B5%D8%A9-e-restaurant-%D9%85%D8%AA%D9%83%D8%A7%D9%85%D9%84%D8%A9-%D8%A8%D8%AA%D8%AC%D8%B1%D8%A8%D8%A9-%D9%85%D8%B3%D8%AA%D8%AE%D8%AF%D9%85-%D9%81%D8%A7%D8%A6%D9%82%D8%A9-uxui-------" target="_blank" class="text-slate-700 hover:text-[#4F5BFF] text-sm font-bold inline-flex items-center gap-1">
                        Live Demo ↗
                    </a>
                </div>
            </div>
            ...
            >
                <div class="space-y-4">
                    ...
                    <h3 class="font-heading text-xl text-slate-900 leading-snug">LawTech Services Website</h3>
                    <p class="text-slate-600 text-sm leading-relaxed">Professional legal services website built with high speed performance, elegant design, and responsive layouts.</p>
                    <div class="flex flex-wrap gap-1.5 pt-2">
                        <span class="bg-slate-100 text-slate-700 text-[11px] px-2.5 py-1 rounded-md font-medium">PHP</span>
                        <span class="bg-slate-100 text-slate-700 text-[11px] px-2.5 py-1 rounded-md font-medium">JavaScript</span>
                        <span class="bg-slate-100 text-slate-700 text-[11px] px-2.5 py-1 rounded-md font-medium">Tailwind CSS</span>
                    </div>
                </div>
                <div class="pt-6 mt-6 border-t border-slate-100 flex items-center justify-between">
                    ...
                    <a href="https://mostaql.com/portfolio/3347152-%D8%AA%D8%B5%D9%85%D9%8A%D9%85-%D9%88%D8%AA%D8%B7%D9%88%D9%8A%D8%B1-%D9%85%D9%88%D9%82%D8%B9-%D8%B4%D8%B1%D9%83%D8%A9-%D8%AE%D8%AF%D9%85%D8%A7%D8%AA-%D9%82%D8%A7%D9%86%D9%88%D9%86%D9%8A%D8%A9-lawtech-------" target="_blank" class="text-slate-700 hover:text-[#4F5BFF] text-sm font-bold inline-flex items-center gap-1">
                        Live Demo ↗
                    </a>
                </div>
            </div>
            ...
            >
                <div class="space-y-4">
                    ...
                    <h3 class="font-heading text-xl text-slate-900 leading-snug">Responsive Landing Page</h3>
                    <p class="text-slate-600 text-sm leading-relaxed">High-performance responsive landing page optimized for conversion rates and smooth cross-device animations.</p>
                    <div class="flex flex-wrap gap-1.5 pt-2">
                        <span class="bg-slate-100 text-slate-700 text-[11px] px-2.5 py-1 rounded-md font-medium">HTML5</span>
                        <span class="bg-slate-100 text-slate-700 text-[11px] px-2.5 py-1 rounded-md font-medium">CSS3</span>
                        <span class="bg-slate-100 text-slate-700 text-[11px] px-2.5 py-1 rounded-md font-medium">JavaScript</span>
                    </div>
                </div>
                <div class="pt-6 mt-6 border-t border-slate-100 flex items-center justify-between">
                    ...
                    <a href="https://mostaql.com/portfolio/3319201-responsive-landing-page-main----" target="_blank" class="text-slate-700 hover:text-[#4F5BFF] text-sm font-bold inline-flex items-center gap-1">
                        Live Demo ↗
                    </a>
                </div>
            </div>
            ...
            >
                <div class="space-y-4">
                    ...
                    <h3 class="font-heading text-xl text-slate-900 leading-snug">Educational Website UI</h3>
                    <p class="text-slate-600 text-sm leading-relaxed">Interactive user interfaces and backend structures for educational portals, ensuring seamless navigation for students and teachers.</p>
                    <div class="flex flex-wrap gap-1.5 pt-2">
                        <span class="bg-slate-100 text-slate-700 text-[11px] px-2.5 py-1 rounded-md font-medium">PHP</span>
                        <span class="bg-slate-100 text-slate-700 text-[11px] px-2.5 py-1 rounded-md font-medium">Bootstrap</span>
                        <span class="bg-slate-100 text-slate-700 text-[11px] px-2.5 py-1 rounded-md font-medium">MySQL</span>
                    </div>
                </div>
                <div class="pt-6 mt-6 border-t border-slate-100 flex items-center justify-between">
                    ...
                    <a href="https://mostaql.com/portfolio/3311927-%D8%A8%D8%B1%D9%85%D8%AC%D8%A9-%D9%88%D8%AA%D8%B5%D9%85%D9%8A%D9%85-%D9%88%D8%A7%D8%AC%D9%87%D8%A7%D8%AA-%D9%85%D8%B3%D8%AA%D8%AE%D8%AF%D9%85-%D9%84%D9%85%D9%88%D9%82%D8%B9-%D8%AA%D8%B9%D9%84%D9%8a%D9%85%D9%8A-----" target="_blank" class="text-slate-700 hover:text-[#4F5BFF] text-sm font-bold inline-flex items-center gap-1">
                        Live Demo ↗
                    </a>
                </div>
            </div>
        ...
        <!-- CTA -->
        <div class="max-w-2xl mx-auto text-center bg-white border border-slate-200 rounded-3xl p-10 shadow-sm mt-16">
            <h3 class="font-heading text-xl text-slate-900 mb-2">Have a project in mind?</h3>
            <p class="text-slate-500 text-sm mb-6">I am open to discussing your technical project details and starting right away.</p>
    ...
    <!-- ============================================================
         FIX: الفوتر كان pb-4 بس هون (كل الصفحات التانية pb-28) —
         وهاد بالظبط سبب انقطاعه تحت الـ Dock العائم بهاي الصفحة
         تحديداً. وحّدناها الآن مع باقي الصفحات.
         ============================================================ -->
    ...
    <nav class="fixed bottom-6 left-1/2 -translate-x-1/2 z-40 bg-white/85 backdrop-blur-md border border-slate-200 px-5 py-3 rounded-full shadow-2xl flex items-center gap-2 sm:gap-4" aria-label="Main navigation">
        <a href="{{ url('/') }}" class="p-3 text-slate-600 hover:text-[#4F5BFF] hover:bg-slate-100 rounded-full transition-all" title="Home" aria-label="Go to Home page">
        ...
        <a href="{{ route('experience') }}" class="p-3 text-slate-600 hover:text-[#4F5BFF] hover:bg-slate-100 rounded-full transition-all" title="Experience" aria-label="Go to Experience page">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7h-4V5a2 2 0 00-2-2h-4a2 2 0 00-2 2v2H4a2 2 0 00-2 2v9a2 2 0 002 2h16a2 2 0 002-2V9a2 2 0 00-2-2zm-8 5h.01M10 7h4"/></svg>
        </a>

        <a href="{{ route('about') }}" class="p-3 text-slate-600 hover:text-[#4F5BFF] hover:bg-slate-100 rounded-full transition-all" title="About" aria-label="Go to About page">
        ...
        <a href="{{ route('projects') }}" class="p-3 text-[#4F5BFF] bg-slate-100 rounded-full transition-all" title="Projects" aria-label="Go to Projects page" aria-current="page">
        ...
        <button @click="contactModal = true" class="p-3 text-slate-600 hover:text-[#4F5BFF] hover:bg-slate-100 rounded-full transition-all" title="Contact" aria-label="Open contact form">
    ...
    >
        <div @click.away="contactModal = false" class="bg-white rounded-3xl shadow-2xl border border-slate-200 w-full max-w-lg p-6 md:p-8 relative space-y-6">
            <button @click="contactModal = false" class="absolute top-6 right-6 w-9 h-9 bg-slate-100 hover:bg-slate-200 rounded-full flex items-center justify-center text-slate-500 transition-colors" title="Close" aria-label="Close contact form">
            ...
            <!-- ============================================================
                 FIX: رسائل نجاح/خطأ كانت مفقودة بالكامل بالـ Modal.
                 ضفناها هون عشان لو حصل خطأ بالـ Validation (بريد غلط
                 مثلاً) أو نجح الإرسال عبر تاب الإيميل، المستخدم يشوف
                 رد فعل واضح بدل ما يبقى بدون أي معلومة.
                 ============================================================ -->
            @if(session('success'))
            ...
            <div class="bg-slate-100 p-1.5 rounded-2xl flex items-center gap-1" role="tablist">
                <button @click="activeTab = 'whatsapp'" :class="activeTab === 'whatsapp' ? 'bg-white text-slate-900 shadow-sm font-bold' : 'text-slate-500 font-medium'" class="flex-1 py-2.5 rounded-xl text-xs flex items-center justify-center gap-2 transition-all" role="tab" :aria-selected="activeTab === 'whatsapp'">
                    <!-- FIX: أيقونة واتساب رجعت -->
                ...
                <button @click="activeTab = 'email'" :class="activeTab === 'email' ? 'bg-white text-slate-900 shadow-sm font-bold' : 'text-slate-500 font-medium'" class="flex-1 py-2.5 rounded-xl text-xs flex items-center justify-center gap-2 transition-all" role="tab" :aria-selected="activeTab === 'email'">
                    <!-- FIX: أيقونة الإيميل رجعت -->
            ...
            <form action="{{ route('contact.store') }}" method="POST" class="space-y-4" id="contactForm">
                ...
                <div>
                    ...
                    <input type="text" name="name" id="cf-name" placeholder="Full Name" required value="{{ old('name') }}" class="w-full bg-[#F4F5FA] border border-slate-200 rounded-2xl px-4 py-3 text-xs text-slate-900 placeholder-slate-400 focus:outline-none focus:border-[#4F5BFF]">
                </div>
                <div>
                    <label for="cf-phone" class="block text-xs font-bold text-slate-700 mb-1">Phone Number *</label>
                    <!--
                        TODO: كود الدولة +972 مؤقت لحد ما تأكد الرقم الصح
                        (970 أم 972) — راجع الملاحظة اللي حطيناها بالرد.
                    -->
                    <div class="flex items-stretch bg-[#F4F5FA] border border-slate-200 rounded-2xl overflow-hidden focus-within:border-[#4F5BFF]">
                        <span class="px-3 flex items-center text-xs font-bold text-slate-500 bg-slate-100 border-l border-slate-200">+972</span>
                        <input type="tel" name="phone" id="cf-phone" placeholder="59 XXX XXXX" required value="{{ old('phone') }}" class="flex-1 bg-transparent px-4 py-3 text-xs text-slate-900 placeholder-slate-400 focus:outline-none">
                    </div>
                </div>
                <div>
                    <label for="cf-message" class="block text-xs font-bold text-slate-700 mb-1">Message *</label>
                    <textarea name="message" id="cf-message" rows="3" placeholder="How can I help you?" required class="w-full bg-[#F4F5FA] border border-slate-200 rounded-2xl px-4 py-3 text-xs text-slate-900 placeholder-slate-400 focus:outline-none focus:border-[#4F5BFF]">{{ old('message') }}</textarea>
                </div>
                ...
                <div class="pt-2 flex flex-col sm:flex-row items-center gap-3">
                    ...
                    <a href="{{ asset('cv/murad-hajjaj-cv.pdf') }}" download class="w-full sm:w-auto bg-white hover:bg-slate-50 border border-slate-200 text-slate-700 font-bold py-3.5 px-6 rounded-2xl transition-all text-xs text-center">
                        Download CV
                    </a>
                </div>
            </form>
