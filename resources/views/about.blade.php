...
>
    ...
    {{-- ============================================================
         FIX: الهيدر رجع لنفس نمط Home/Experience/Projects —
         أيقونات حقيقية (Email/YouTube/GitHub/Mostaql) بنفس الروابط
         الصحيحة، بدل نصوص "Email/YouTube/GitHub/Mostaql" بروابط "#"
         فاضية وبريد إلكتروني غلط (hello@muradhajjaj.dev) كانوا موجودين.
         ============================================================ --}}
