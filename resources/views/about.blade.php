...
>
    ...
    <!-- Header (same as Home / Experience / Projects) -->
    <!-- FIX: كان max-w-4xl هون بس max-w-6xl بكل صفحة تانية — وحّدناها
         عشان عرض المحتوى ما يقفز فجأة لما الزائر يتنقل بين الصفحات -->
    ...
    <main class="max-w-6xl mx-auto px-6 pt-2 pb-28 space-y-8">
        ...
        <div class="text-center space-y-1">
            ...
            <h1 class="font-heading text-4xl md:text-5xl uppercase tracking-tight">About Me</h1>
        </div>

        <!-- 1. Positioning Statement Card -->
        <div class="bg-[#0F1115] text-white p-8 md:p-10 rounded-3xl shadow-xl space-y-2 relative overflow-hidden max-w-4xl mx-auto">
            ...
            <p class="font-heading text-2xl md:text-3xl tracking-wide leading-snug">
        ...
        <div class="grid grid-cols-1 md:grid-cols-12 gap-6 max-w-4xl mx-auto">
            ...
            <div class="md:col-span-5 grid grid-cols-1 gap-6">
                <div class="bg-white p-6 rounded-3xl shadow-sm border border-slate-200 flex flex-col justify-center">
                    <span class="font-heading text-3xl text-slate-900 mb-1">2+</span>
                    <span class="text-xs md:text-sm text-slate-500 font-medium">Years experience</span>
                </div>
                <div class="bg-white p-6 rounded-3xl shadow-sm border border-slate-200 flex flex-col justify-center">
                    <span class="font-heading text-3xl text-slate-900 mb-1">6+</span>
                    <span class="text-xs md:text-sm text-slate-500 font-medium">Projects shipped</span>
                </div>
            </div>
        </div>

        <!-- 3. WHO AM I? Card -->
        <section class="bg-white border border-slate-200 p-8 md:p-10 rounded-3xl shadow-sm space-y-4 text-slate-600 leading-relaxed max-w-4xl mx-auto">
            <h2 class="font-heading text-xl text-slate-900 uppercase tracking-wide">Who Am I?</h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 items-stretch max-w-4xl mx-auto">
            <div class="bg-white border border-slate-200 p-8 rounded-3xl shadow-sm flex flex-col justify-between space-y-4">
                <div>
                    <span class="text-[#4F5BFF] font-mono text-xs uppercase tracking-widest font-semibold block mb-2">&bull; Live Code Preview</span>
                    <h3 class="font-heading text-xl text-slate-900 mb-4">Code that speaks for itself</h3>
            ...
            <div class="bg-[#0F1115] border border-slate-800 p-6 rounded-3xl shadow-lg font-mono text-xs md:text-sm text-slate-300 flex flex-col justify-center overflow-x-auto">
                <div class="text-slate-500 mb-3 pb-2 border-b border-slate-800 flex items-center justify-between">
    ...
    <span class="text-purple-400">public function</span> <span class="text-blue-300">deploy</span>() {
        ...
        <!-- 5. Toolkit Section -->
        <section class="bg-white border border-slate-200 p-8 rounded-3xl shadow-sm space-y-4 max-w-4xl mx-auto">
            <h2 class="font-heading text-xl text-slate-900 uppercase tracking-wide">Toolkit</h2>
            <div class="flex flex-wrap items-center gap-3">
                <span class="bg-[#4F5BFF]/10 text-[#4F5BFF] px-4 py-2 rounded-xl text-sm font-semibold">PHP / Laravel</span>
                <span class="bg-slate-100 text-slate-700 px-4 py-2 rounded-xl text-sm font-medium">Node.js</span>
                <span class="bg-slate-100 text-slate-700 px-4 py-2 rounded-xl text-sm font-medium">MySQL / PostgreSQL</span>
                <span class="bg-slate-100 text-slate-700 px-4 py-2 rounded-xl text-sm font-medium">MongoDB</span>
                <span class="bg-slate-100 text-slate-700 px-4 py-2 rounded-xl text-sm font-medium">Docker</span>
                <span class="bg-slate-100 text-slate-700 px-4 py-2 rounded-xl text-sm font-medium">Git & GitHub</span>
            </div>
        </section>
    ...
    <nav class="fixed bottom-6 left-1/2 -translate-x-1/2 z-40 bg-white/80 backdrop-blur-md border border-slate-200/80 px-4 py-3 rounded-full shadow-2xl flex items-center gap-2 sm:gap-4" aria-label="Main navigation">
        ...
        <a href="{{ route('about') }}" class="p-3 text-[#4F5BFF] bg-slate-100 rounded-full transition-all" title="About" aria-label="Go to About page" aria-current="page">
        ...
        <a href="{{ route('projects') }}" class="p-3 text-slate-600 hover:text-[#4F5BFF] hover:bg-slate-100 rounded-full transition-all" title="Projects" aria-label="Go to Projects page">
